/** The redux reducers is just a pure function that specifies how the application state should change in 
response to actions. This reducers handle data related to restaurants */ 
